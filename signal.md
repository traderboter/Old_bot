...
🔹 مرحله 9: ⚠️ Reversal Detection
    ...
    └─ تأثیر بر timeframe_weight و alignment
    ↓
🔹 مرحله 10-11: Adaptive Learning → ضرب در 13 ضریب → final_score
    ↓
🔹 فیلتر 8: ⚠️ Min Score
...
- ✅ **5 Score Modifier** که فقط امتیاز را تغییر می‌دهند
...
- ✅ **همه 5 Score Modifier مستند شده‌اند** - با فرمول‌های دقیق
...
3. ✅ بررسی تمام فیلترهای بحرانی
4. ✅ تصحیح موارد اشتباه (Volatility Filter)
5. ✅ اضافه کردن موارد از قلم افتاده (Valid DataFrame Filter)

**نسخه مستندات:** 2.2 (کامل، تصحیح شده، و بررسی نهایی انجام شده)

**تاریخ به‌روزرسانی آخر:** 2025-11-10 (بررسی دوم کامل)
