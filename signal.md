...
2. 🚫 **Direction Clarity Check** - جهت باید واضح باشد (حداقل 10% اختلاف)
3. 🚫 **BTC Correlation Check** - سازگاری با ترند بیت‌کوین
4. 🚫 **Min Risk/Reward** - حداقل RR لازم (معمولاً 2.0-4.0)
5. 🚫 **Min Score** - حداقل امتیاز نهایی (33-42 بسته به regime)
6. 🚫 **Volatility Filter** - رد سیگنال در نوسان افراطی
